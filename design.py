...
def main():
    ...
    mue     = (M_tot) / H_f       # t/m      # t/m       // Only from vertical loading/slabs 
    dns     = ['D', 'L']
    ...
    # Moment of Intertia   
    I = ((b+t/2)**4-(b-t/2)**4)/12

    # ULS
    # SLS
    u_lim   = H_f / 600         # u_r_max < u_lim
    ...
    for dn in dns:    
        ...
        while delta_tip_r_max > u_lim:
            ...
            buildProp = modelProp.buildProp(H_f, B, dn, E, I_iter, mue, D, windStats.uH[rPeriod])
